...
public class tugas7 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ListMinuman.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "jus jeruk", "kopi", "teh manis", "soda", "air mineral", "es teler", "lemon tea", "lychee tea", "jus alpukat", "jus mangga" };
...
// TODO add your handling code here:
    ...
    String Kota = AreaKota.getText();
    String Kota = AreaKota.getText();
    String Kota = AreaKota.getText();
       
    //masukan data ke dalam AreaKota (JTextArea)
    AreaKota.append(kota + "\n");
    
    //masukan data ke dalam cbMakanan (JComboBox)
    if (!makanan.isEmpty()) {
        CbMakanan.addItem(makanan);
    }
    
    //masukan data ke dalam cbMinuman (JList)
    if (!Minuman.isEmpty()) {
        ListMinuman.addElement(Minuman);
    }
